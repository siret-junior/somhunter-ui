    ...
    (t = function (e) {
        ...
        function F() {
            ...
            l.onmessage = function (e) {
                ("file://" !== l.location.origin &&
                    e.origin !== l.location.origin) ||
                    (e &&
                        e.data &&
                                ...
                                (r.innerText = "("
                                    ...
                                    (t.onload = function () {
                                        t.contentWindow.addEventListener(
                                            ...
                                            t.contentDocument.head.appendChild(
                                                r
                                            ),
                                            t.contentDocument.head.appendChild(
                                                n
                ...
                o = (function () {
                    ...
                    function n(e, t) {
                        ...
                        (i.innerText = "("
                            ...
                            .concat(c, "');")),
                            (n.onload = function () {
                                n.contentWindow.addEventListener(
                                    "error",
                                    D,
                                    !0
                                ),
            ...
            console.group("Font Awesome Detector"),
                0 === i
                    ...
                    : (console.info(
                          "Testing ".concat(i, " possible conflicts.")
                      ),
                      console.info(
                          "We'll wait about ".concat(
                              Math.round(l.FontAwesomeDetection.timeout / 10) /
                                  100,
                              " seconds while testing these and\n"
                          ) +
                              "then up to another ".concat(
                                  Math.round(
                                      l.FontAwesomeDetection
