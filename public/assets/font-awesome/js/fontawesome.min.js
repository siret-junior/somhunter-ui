...
!(function () {
    ...
    function Jt(t) {
        return t.reduce(function (t, e) {
            ...
            if (Gt[e]) t.prefix = e;
            else if (et.autoFetchSvg && -1 < Object.keys(z).indexOf(e))
                t.prefix = e;
            else if (n) {
                var a =
                    "fa" === t.prefix
                        ? Vt[n] || { prefix: null, iconName: null }
                        : {};
                    ...
                    At(t).forEach(function (t) {
                        if (
                            ("childList" === t.type &&
                                ...
                                !te(t.addedNodes[0]) &&
                                (et.searchPseudoElements && o(t.target),
                                r(t.target)),
                            "attributes" === t.type &&
                                t.target.parentNode &&
    ...
    function xe(t) {
        ...
        return ~a.extra.classes.indexOf(j)
            ...
            : ((i = t),
              ...
              (m = e.extra),
              new vt(function (r, t) {
                  vt.all([ye(o, l), ye(n.iconName, n.prefix)]).then(function (
                      t
                  ) {
                      var e = p(t, 2),
                          n = e[0],
    ...
    function Ce(p, h) {
        ...
        return new vt(function (a, t) {
            ...
            if (r && "none" !== o && "" !== o) {
                ...
                if (
                    !f ||
                    (e && e.getAttribute(C) === s && e.getAttribute(O) === u)
                )
                    a();
                else {
                                ...
                                (e.definitions[t] = $(
                                    ...
                                    (function t(e, a) {
                                        var n = (2 < arguments.length &&
                                            ...
                                            {});
                                        "function" != typeof W.hooks.addPack ||
                                        r
                                            ? (W.styles[e] = $(
                                                  {},
                                                  W.styles[e] || {},
